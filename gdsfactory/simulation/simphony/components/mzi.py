...
def mzi(
    ...
    straight_top: Callable = straight,
    straight_bot: Callable = straight,
    ...
    splitter[port_name_splitter_e0].connect(wg_long["o1"])
    splitter[port_name_splitter_e1].connect(wg_short["o1"])
